...
- (IBAction)pressCheckChoose:(id)sender {
    ...
    switch (self.cardType) {
        case CardTypeIdCardFont:{
            ...
            [NetWorkTool postNetWorkWithImage:self.finalImage types:CardTypeIdCardFont withURL:nil paramaters:nil success:^(id object) {
                if ([self.delegate respondsToSelector:@selector(ocrOnIdCardSuccessful:)]) {
                                        [self.delegate ocrOnIdCardSuccessful:object];
                                    }
                
            } failure:^(id failure) {
                if ([self.delegate respondsToSelector:@selector(ocrOnFail:)]) {
                                       [self.delegate ocrOnFail:failure];
                                   }
        ...
        case CardTypeIdCardBack:
        {
            ...
            [NetWorkTool postNetWorkWithImage:self.finalImage types:CardTypeIdCardBack withURL:nil paramaters:nil success:^(id object) {
                if ([self.delegate respondsToSelector:@selector(ocrOnIdCardSuccessful:)]) {
                    [self.delegate ocrOnIdCardSuccessful:object];
                }
        ...
        case CardTypeBankCard: {
            ...
            [NetWorkTool postNetWorkWithImage:self.finalImage types:CardTypeBankCard withURL:nil paramaters:nil success:^(id object) {
                if ([self.delegate respondsToSelector:@selector(ocrOnBankCardSuccessful:)]) {
                    [self.delegate ocrOnBankCardSuccessful:object];
                }
